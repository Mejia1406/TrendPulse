...
const props = defineProps<{
  ...
  getLatestViews: Function;
  getSocialMediaName: Function;
}>();
  ...
  <BaseCard class="mt-8 overflow-hidden">
    ...
    >
      ...
      <h3 class="text-xl font-semibold">
        ...
        Resultados ({{ props.trends.length }})
