...
<template>
  <main class="grid min-h-screen place-items-center bg-slate-950 px-4 text-white">
    <div class="w-full max-w-md">
      ...
      <section class="rounded-2xl border border-slate-700 bg-slate-900 p-8 shadow-2xl">
        <h1 class="text-2xl font-bold">Bienvenido</h1>

        <p class="mt-1 text-sm text-slate-400">Ingresa a tu panel de análisis.</p>
        ...
        >
          <p class="font-medium text-white">Cuentas demo</p>

          <p class="mt-1">Admin: smoncadam@eafit.edu.co / 123456</p>

          <p>Usuario: shurtadom3@eafit.edu.co / 123456</p>
        </div>

        <p class="mt-6 text-center text-sm text-slate-400">
          ¿No tienes cuenta?
          <RouterLink to="/about" class="text-teal-400 hover:underline">
